...
# Data directory
__C.DATA_DIR = osp.abspath('D:\Faster_R-CNN\data')
...
def get_output_dir(imdb, weights_filename):
  ...
  (if not None).
  """
  # outdir = osp.abspath(osp.join( 'output', __C.EXP_DIR, imdb.name))
  outdir = osp.abspath(osp.join('output',imdb.name))
